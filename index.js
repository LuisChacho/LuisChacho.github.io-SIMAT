const bancoOriginal = [
    ...
    },
    {
        ...
        "pregunta": "Pregunta N° 2 - Calcule el value exacto de la operación radical contextualizada: √(54) + √(18) - √(8)",
        "opcionesBase": {
            "correcta": "6√2",
            "inc1": "4√2",
            "inc2": "8√2",
    ...
    {
        "categoria": "Números Reales",
        "pregunta": "Pregunta N° 17 - Calcule el value exacto de la operación radical contextualizada: √(54) + √(18) - √(8)",
        "opcionesBase": {
            "correcta": "6√2",
            "inc1": "4√2",
            "inc2": "8√2",
    ...
    {
        "categoria": "Números Reales",
        "pregunta": "Pregunta N° 32 - Calcule el value exacto de la operación radical contextualizada: √(54) + √(18) - √(8)",
        "opcionesBase": {
            "correcta": "6√2",
            "inc1": "4√2",
            "inc2": "8√2",
    ...
    {
        "categoria": "Números Reales",
        "pregunta": "Pregunta N° 47 - Calcule el value exacto de la operación radical contextualizada: √(54) + √(18) - √(8)",
        "opcionesBase": {
            "correcta": "6√2",
            "inc1": "4√2",
            "inc2": "8√2",
    ...
    {
        "categoria": "Números Reales",
        "pregunta": "Pregunta N° 62 - Calcule el value exacto de la operación radical contextualizada: √(54) + √(18) - √(8)",
        "opcionesBase": {
            "correcta": "6√2",
            "inc1": "4√2",
            "inc2": "8√2",
    ...
    {
        "categoria": "Números Reales",
        "pregunta": "Pregunta N° 77 - Calcule el value exacto de la operación radical contextualizada: √(54) + √(18) - √(8)",
        "opcionesBase": {
            "correcta": "6√2",
            "inc1": "4√2",
            "inc2": "8√2",
    ...
    {
        "categoria": "Números Reales",
        "pregunta": "Pregunta N° 92 - Calcule el value exacto de la operación radical contextualizada: √(54) + √(18) - √(8)",
        "opcionesBase": {
            "correcta": "6√2",
            "inc1": "4√2",
            "inc2": "8√2",
    ...
    {
        "categoria": "Números Reales",
        "pregunta": "Pregunta N° 107 - Calcule el value exacto de la operación radical contextualizada: √(54) + √(18) - √(8)",
        "opcionesBase": {
            "correcta": "6√2",
            "inc1": "4√2",
            "inc2": "8√2",
    ...
    {
        "categoria": "Números Reales",
        "pregunta": "Pregunta N° 122 - Calcule el value exacto de la operación radical contextualizada: √(54) + √(18) - √(8)",
        "opcionesBase": {
            "correcta": "6√2",
            "inc1": "4√2",
            "inc2": "8√2",
    ...
    {
        "categoria": "Números Reales",
        "pregunta": "Pregunta N° 137 - Calcule el value exacto de la operación radical contextualizada: √(54) + √(18) - √(8)",
        "opcionesBase": {
            "correcta": "6√2",
            "inc1": "4√2",
            "inc2": "8√2",
    ...
    {
        "categoria": "Números Reales",
        "pregunta": "Pregunta N° 152 - Calcule el value exacto de la operación radical contextualizada: √(54) + √(18) - √(8)",
        "opcionesBase": {
            "correcta": "6√2",
            "inc1": "4√2",
            "inc2": "8√2",
    ...
    {
        "categoria": "Números Reales",
        "pregunta": "Pregunta N° 167 - Calcule el value exacto de la operación radical contextualizada: √(54) + √(18) - √(8)",
        "opcionesBase": {
            "correcta": "6√2",
            "inc1": "4√2",
            "inc2": "8√2",
    ...
    {
        "categoria": "Números Reales",
        "pregunta": "Pregunta N° 182 - Calcule el value exacto de la operación radical contextualizada: √(54) + √(18) - √(8)",
        "opcionesBase": {
            "correcta": "6√2",
            "inc1": "4√2",
            "inc2": "8√2",
    ...
    {
        "categoria": "Números Reales",
        "pregunta": "Pregunta N° 197 - Calcule el value exacto de la operación radical contextualizada: √(54) + √(18) - √(8)",
        "opcionesBase": {
            "correcta": "6√2",
            "inc1": "4√2",
            "inc2": "8√2",
...
function nextQuestion() {
    ...
    if (currentIndex < preguntasPartida.length) {
        ...
        document.getElementById('end-message').innerText = `Completaste las 200 preguntas con un total de ${score} aciertos.`;
    }
}
...
function endGameByTimeout() {
    ...
    showScreen('screen-end');
    document.getElementById('end-message').innerText = `¡Tiempo límite agotado! Lograste ${score} puntos.`;
}
...
function usePhone() {
    ...
    helpDiv.innerText = `💡 El Profesor indica: 'La opción correcta es la [${q.correcta}].'`;
...
function useAudience() {
    ...
    let helpDiv = document.getElementById('help-display');
    helpDiv.style.display = 'block';
    helpDiv.innerText = `📊 Público: La mayoría apunta a la opción [${q.correcta}].`;
