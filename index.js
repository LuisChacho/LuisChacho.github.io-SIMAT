...
function usePhone() {
    ...
    helpDiv.innerText = `☎️ Tu profesor tutor en la línea dice: 'Analizé el problema rigurosamente y la respuesta correcta indudablemente corresponde al literal ${q.correcta}.'`;
